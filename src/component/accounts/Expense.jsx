...
const Expense = () => {
  ...
  const handleSave = async () => {
    await axios
      .post("https://inv.orivesolutions.com/accounts/expense", formData)
      .then((result) => {
        handleClose();
        getItemData();
      })
  ...
  const deleteItem = async (id) => {
    await axios
      .delete(`https://inv.orivesolutions.com/expense/delete/${id}`)
      .then(() => {
        getItemData();
      })
      .catch((err) => console.error(err));
  ...
  const getItemData = async () => {
    await axios
      .get("https://inv.orivesolutions.com/accounts/expense")
