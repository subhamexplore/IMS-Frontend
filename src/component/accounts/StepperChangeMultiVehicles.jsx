...
import ChangeMultiVehicle from "./ChangeMultiVehicles";

function StepperChangeMultiVehicle() {
                ...
                <div>
                  ...
                  <Container component={Box} p={4}>
                    <Paper component={Box} p={3}>
                      <ChangeMultiVehicle state={state} />
                    </Paper>
                  </Container>
                </div>
              </div>
...
export default StepperChangeMultiVehicle;
