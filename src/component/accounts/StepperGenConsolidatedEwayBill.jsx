...
import GenConsolidatedEwayBill from "./GenConsolidatedEwayBill";

function StepperGenConsolidatedEwayBill() {
                ...
                <div>
                  ...
                  <Container component={Box} p={4}>
                    <Paper component={Box} p={3}>
                      <GenConsolidatedEwayBill state={state} />
                    </Paper>
                  </Container>
                </div>
              </div>
...
export default StepperGenConsolidatedEwayBill;
