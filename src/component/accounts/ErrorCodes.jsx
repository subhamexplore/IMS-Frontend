export const errorCodes = [
  ...
  { 239: "Invalid action" },
  { 240: "Could not generate eway bill, please contact helpdesk" },
  ...
  {
    282: "At least 4 digits HSN code is mandatory for taxpayers with turnover less than 5cr.",
  },
  {
    283: "At least 6 digits HSN code is mandatory for taxpayers with turnover less than 5cr. and above.",
  },
  ...
  { 307: "Invalid reason" },
  { 308: "Invalid remarks" },
  { 309: "Could not update vehicle details, please contact helpdesk" },
  ...
  {
    366: "You will not get the ewaybills generated today, however you can access the ewaybills of yesterdays",
  },
  ...
  { 428: "For Goods Detained, Vehicle Released field is mandatory" },
  ...
  { 647: "Could not insert RFID data, please contact helpdesk" },
  {
  ...
  {
    658: "You are blocked for accessing this API as the allowed number of requests has been exceeded for this duration",
  },
  ...
  {
    703: "Since the consignor is a Composite Taxpayer, inter-state transactions are not allowed",
  },
  {
    704: "Since the consignor is a Composite Taxpayer, Tax rates should be zero",
  },
  ...
  { 714: "Document type - Tax Invoice is not allowed for composite taxpayers" },
  {
    715: "The Consignor GSTIN is blocked from e-waybill generation as Return is not filed for the past 2 months",
  },
  {
    716: "The Consignee GSTIN is blocked from e-waybill generation as Return is not filed for the past 2 months",
  },
  {
    717: "The Transporter GSTIN is blocked from e-waybill generation as Return is not filed for the past 2 months",
  },
  {
    718: "The User GSTIN is blocked from Transporter Updation as Return is not filed for the past 2 months",
  },
  {
    719: "The Transporter GSTIN is blocked from Transporter Updation as Return is not filed for the past 2 months",
  },
  {
    720: "The E Way Bill should be generated as part of IRN generation or with reference to IRN in E Invoice System, Since Supplier is enabled for E Invoice",
  },
  {
    721: "The distance between the given pincodes is not available in the system. Please provide the distance",
  },
  {
  ...
  { 726: "Vehicle type cannot be regular when transportation mode is ship" },
  {
    727: "For Ship Transport, either vehicle number or transport document number is required",
  },
  { 728: "You can cancel the e-waybill within 24 hours from Part B entry" },
  {
