...
const SalesForm = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://inv.orivesolutions.com/inventory"
        );
  ...
  const getUnique = async () => {
    if (dataScan) {
      await axios
        .get(`https://inv.orivesolutions.com/find-item/${dataScan}`)
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      const response = await fetch("https://inv.orivesolutions.com/order", {
        method: "POST",
        body: JSON.stringify({
          amount,
          currency,
                    ...
                    <button
                      ...
                      onClick={async (e) => {
                        formData.method === "cash"
                          ...
                          : paymentHandler(e);
                        await axios.post(
                          "https://inv.orivesolutions.com/sales",
                          formData
                        );
                      }}
                    >
