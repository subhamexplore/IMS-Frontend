...
const BuyersSuppliers = () => {
  ...
  const handleSave = async () => {
    await axios
      .post("https://inv.orivesolutions.com/buyers-suppliers", formData)
      .then(() => {})
            ...
            <div className="wrapper buyer-wrapper">
              <div className="container">
                ...
                >
                            ...
                            <table className="table table-hover table-striped text-nowrap table-vcenter mb-0">
                              ...
                              <tbody>
                                {currentSupplyItems.map((item, index) => (
                                  <tr key={index}>
                                    <td>
                                      {index + indexOfFirstSupplyItem + 1}
                                    </td>
                                    <td>{item.name}</td>
                                    <td>{item.mobileNumber}</td>
                                    <td>{item.gstin}</td>
                  ...
                  <div>
                    Page {totalSupplyPages === 0 ? 0 : currentSupplyPage} of{" "}
                    {totalSupplyPages}
                  </div>
                </div>
                ...
                >
                  ...
                  <div>
                    Page {totalPayPages === 0 ? 0 : currentPayPage} of{" "}
                    {totalPayPages}
                  </div>
                </div>
                ...
                >
                            ...
                            <table className="table table-hover table-striped text-nowrap table-vcenter mb-0">
                              ...
                              <tbody>
                                {currentCollectItems.map((item, index) => (
                                  <tr key={index}>
                                    <td>
                                      {index + indexOfFirstCollectItem + 1}
                                    </td>
                                    <td>{item.name}</td>
                                    <td>{item.mobileNumber}</td>
                                    <td>{item.gstin}</td>
                  ...
                  <div>
                    Page {totalCollectPages === 0 ? 0 : currentCollectPage} of{" "}
                    {totalCollectPages}
                  </div>
                </div>
              </div>
